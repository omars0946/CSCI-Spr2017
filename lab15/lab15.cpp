...
int main() {
    ...
    string Name, Action, Team, Body_part, Fear, Object, Creature;
...
// Building the story
cout << "___________________________DO NOT READ UNTIL YOU FINISH QUESTIONARE_______________________________”;
    cout << "   " << endll;

cout << "A person named " << Name << ", " << "was arrested this morning after he/she " ” << Action << " in front of the"  << Team;
cout << "They were so upset with " << Name << "That they threw a chair directly at " << name << "'s face!";
